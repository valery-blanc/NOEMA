...
export const Hero: Block = {
  ...
  fields: [
    ...
    { name: 'heading', type: 'text', required: true, admin: { description: 'Titre simple (sans mise en forme). Laissé tel quel si « Titre mis en forme » est vide.' } },
    { name: 'headingRich', type: 'richText', admin: { description: 'Titre mis en forme (gras, italique, retour à la ligne) — ex. une citation. Prioritaire sur le titre simple.' } },
    { name: 'attribution', type: 'text', admin: { description: 'Ligne plus petite sous le titre (ex. auteur de la citation). Optionnel.' } },
